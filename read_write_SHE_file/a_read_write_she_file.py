...
dat = open("Broward_VA3.she", 'r+')

lines = dat.readlines()

# write new lines to a new SHE file
with open('Broward_VA3_test.she', 'w', encoding='utf-8') as file:  
    for txt in lines:
        print(txt)
            
        if "Meteorologic\\100y\\1" in txt:
            # print(txt)
            txt = txt.replace('Meteorologic\\100y\\1', 'Meteorologic\\100y_0901\\1')
            # print(txt)
