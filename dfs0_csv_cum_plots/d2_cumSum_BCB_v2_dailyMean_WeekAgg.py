...
Updated: take daily mean - aggregate total volume weekly
...
dir_sim = 'R:\\40715-010\\Data\\calibration_stats\\bcb_stat_summary\\1023\\flow_stats'
# dir_out = 'R:\\40715-010\\Data\\calibration_stats\\bcb_stat_summary\\0828\\flow_stats\\calculated_flows'
dir_table = 'R:\\40715-010\\Data\\calibration_stats\\bcb_stat_summary\\1023\\flow_stats'
...
# change
####
sim = pd.read_csv('BCB-MODEL-39DetailedTS_M11.csv')
print(sim)
...
for ss in stn:
    ...
    # # # when looking at a unique date
    # obs_agg = obs_agg[(obs_agg['datetime'] >= '2017-07-01') & (obs_agg['datetime'] <= '2018-03-30')]
    # sim_agg = sim_agg[(sim_agg['datetime'] >= '2017-07-01') & (sim_agg['datetime'] <= '2018-03-30')]
