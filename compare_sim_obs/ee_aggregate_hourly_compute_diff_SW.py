...
sim_dir = 'R:\\40715-010\\Data\\calibration_stats\\flow_stats\\sim_flows'
out_dir = 'R:\\40715-010\\Data\\calibration_stats\\flow_stats\\merged_v2'
...
os.chdir(sim_dir)
sim = pd.read_csv('detailedM11TS.csv')
