...
sim_dir = "R:\\40715-013 UKFPLOS\\Data\\H&H_Data\\calibration_validation_stats\\"\
                    "cal_0608_v13_AugIC_MixCoef\\flow_stats\\sim_flows"
out_dir = "R:\\40715-013 UKFPLOS\\Data\\H&H_Data\\calibration_validation_stats\\"\
                    "cal_0608_v13_AugIC_MixCoef\\flow_stats\\merged_flow"
...
for station in sList:
    ...
    os.chdir(sim_dir)
    sim = pd.read_csv('Cal_0608_v13_AugIC_MixCoefDetailedTS_M11.csv')
